{
  ...
  google-protobuf = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-1RbBMkhQD7Thr0acLXHotuz/rLb1XpviA/AbfQ/wHv8=";
      type = "gem";
    };
    version = "3.22.2";
  };
  ...
  nokogiri = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-x2WnSqxs9DCnELsLYDi47hHxdzk81q6NrcekSm4mWLY=";
      type = "gem";
    };
    version = "1.14.2";
  };
  ...
  sass-embedded = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0srwrnlyd31w8251pwfhvz2dnss3ng6r24ilnrzv1dh9zla7d72g";
      type = "gem";
    };
    version = "1.60.0";
  };
